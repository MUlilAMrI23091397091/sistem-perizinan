        ...
        <table class="ttd-table">
            ...
            <tr>
                ...
                <td colspan="5" class="ttd-right">
                    <div class="ttd-right-date"><strong><?php echo e($ttdSettings->menyetujui_lokasi ?? 'Surabaya'); ?>, <?php echo e($ttdSettings->menyetujui_tanggal ? \Carbon\Carbon::parse($ttdSettings->menyetujui_tanggal)->format('d F Y') : date('d F Y')); ?></strong></div>
                </td>
            </tr>
