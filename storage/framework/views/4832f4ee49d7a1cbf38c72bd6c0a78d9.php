    ...
    <div class="ttd-section">
        <div class="ttd-container">
            ...
            <div class="ttd-item" style="text-align: left;">
                ...
                <div class="ttd-name" style="text-align: left;"><?php echo e($ttdSettings->mengetahui_nama); ?></div>
                <div class="ttd-text" style="text-align: left;"><?php echo e($ttdSettings->mengetahui_pangkat); ?></div>
                <div class="ttd-nip" style="text-align: left;">NIP: <?php echo e($ttdSettings->mengetahui_nip); ?></div>
            </div>

            <!-- Menyetujui (kanan) -->
            <div class="ttd-item" style="text-align: right;">
                <div class="ttd-text" style="font-weight: bold; text-align: right;"><?php echo e($menyetujuiTitle); ?></div>
                ...
                <div class="ttd-name" style="text-align: right;"><?php echo e($ttdSettings->menyetujui_nama); ?></div>
                <div class="ttd-text" style="text-align: right;"><?php echo e($ttdSettings->menyetujui_pangkat); ?></div>
                <div class="ttd-nip" style="text-align: right;">NIP: <?php echo e($ttdSettings->menyetujui_nip); ?></div>
            </div>
        </div>
    </div>
</body>
