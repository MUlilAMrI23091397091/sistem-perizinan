        ...
        <div class="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-6">
                        ...
                        <div class="flex gap-2">
                            ...
                            <div class="relative custom-dropdown">
                                <select name="status" onchange="this.form.submit()" class="h-11 pl-3 pr-8 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm appearance-none bg-white cursor-pointer">
                                    ...
                                    <option value="Menunggu" <?php echo e(($selectedStatus ?? '') == 'Menunggu' ? 'selected' : ''); ?>>Menunggu</option>
            ...
            <div class="flex flex-col gap-3 w-full xl:w-auto xl:min-w-0">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <a href="<?php echo e(route('permohonan.export.pdf-landscape')); ?>" 
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
        <div class="px-6 py-4 border-b border-gray-200" style="background-color: #F8FAFC;">
            <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium px-3 py-1 rounded-full" style="background-color: #E0E7FF; color: #3B82F6;"><?php echo e($permohonans->count()); ?> Data</span>
            </div>
        </div>
                    ...
                    <tr class="<?php echo e($rowClass); ?> transition-colors duration-200">
                        ...
                        <td class="px-4 py-4 text-sm text-gray-500">
                            <div class="flex flex-col">
                                <span class="text-xs"><?php echo e(($permohonan && $permohonan->created_at) ? $permohonan->created_at->setTimezone('Asia/Jakarta')->locale('id')->translatedFormat('d M Y') : '-'); ?></span>
                            </div>
                        </td>
                        <!-- Aksi -->
                ...
                <div class="<?php echo e($cardClass); ?> rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-900"><?php echo e(($permohonan && $permohonan->created_at) ? $permohonan->created_at->setTimezone('Asia/Jakarta')->locale('id')->translatedFormat('d M Y') : '-'); ?></p>
                        </div>
                    </div>
