...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-6 bg-white rounded-lg shadow-sm p-6">
        <form method="GET" action="<?php echo e(route('permohonan.index')); ?>" class="flex flex-col md:flex-row gap-4">
            <!-- Search -->
            <div class="flex-1">
                <div class="flex">
            ...
            <div class="md:w-96 flex gap-3 items-end">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium shadow-sm transition-colors">
                        Filter
                    </button>
                    <a href="<?php echo e(route('permohonan.index')); ?>" class="px-4 py-2.5 bg-gray-500 text-white rounded-lg hover:bg-gray-600 text-sm font-medium shadow-sm transition-colors">
                        Reset
                    </a>
                </div>
            </div>
            ...
            <!-- Tambah Permohonan -->
            <div>
                <a href="<?php echo e(route('permohonan.create')); ?>" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            <div class="flex items-center justify-between">
                ...
                <span class="bg-blue-100 text-blue-800 text-sm font-medium px-3 py-1 rounded-full">
                    <?php echo e($permohonans->total()); ?> Data
                </span>
            </div>
        </div>
