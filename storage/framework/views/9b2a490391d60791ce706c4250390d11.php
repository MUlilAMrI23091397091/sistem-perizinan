        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <form method="POST" action="<?php echo e(route('permohonan.update', $permohonan)); ?>"
                          x-data="{ jenisPelakuUsaha: '<?php echo e(old('jenis_pelaku_usaha', $permohonan->jenis_pelaku_usaha) ?? 'Badan Usaha'); ?>' }">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp">
                                    ...
                                    <input id="no_permohonan" name="no_permohonan" type="text"
                                        ...
                                        value="<?php echo e(old('no_permohonan', $permohonan->no_permohonan)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp">
                                    ...
                                    <input id="tanggal_permohonan" name="tanggal_permohonan" type="date"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['pd_teknis']) ? 'bg-gray-100' : ''); ?>"
                                        value="<?php echo e(old('tanggal_permohonan', $permohonan->tanggal_permohonan ? $permohonan->tanggal_permohonan->format('Y-m-d') : '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp">
                                    ...
                                    <select name="jenis_pelaku_usaha" id="jenis_pelaku_usaha"
                                        ...
                                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isDisabled(['pd_teknis']) ? 'bg-gray-100' : ''); ?>"
                                        <?php echo e($isDisabled(['pd_teknis']) ? 'disabled' : ''); ?> required>
                                        ...
                                        <?php $__currentLoopData = $jenisPelakuUsahas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($jenis); ?>" <?php if(old('jenis_pelaku_usaha', $permohonan->jenis_pelaku_usaha) == $jenis): echo 'selected'; endif; ?>>
                                                <?php echo e($jenis); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp" x-show="jenisPelakuUsaha === 'Orang Perseorangan'">
                                    ...
                                    <input id="nik" name="nik" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['pd_teknis']) ? 'bg-gray-100' : ''); ?>"
                                        value="<?php echo e(old('nik', $permohonan->nik)); ?>" placeholder="Masukkan 16 digit NIK" maxlength="16"
                                        <?php echo e($isReadOnly(['pd_teknis']) ? 'readonly' : ''); ?> />
                                    <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp" x-show="jenisPelakuUsaha === 'Badan Usaha'">
                                    ...
                                    <select name="jenis_badan_usaha" id="jenis_badan_usaha"
                                        ...
                                        <option value="Perseroan Terbatas (PT)" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Perseroan Terbatas (PT)'): echo 'selected'; endif; ?>>
                                            Perseroan Terbatas (PT)
                                        </option>
                                        <option value="Perseroan Terbatas (PT) Perorangan" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Perseroan Terbatas (PT) Perorangan'): echo 'selected'; endif; ?>>
                                            Perseroan Terbatas (PT) Perorangan
                                        </option>
                                        <option value="Persekutuan Komanditer (CV/Commanditaire Vennootschap)" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Persekutuan Komanditer (CV/Commanditaire Vennootschap)'): echo 'selected'; endif; ?>>
                                            Persekutuan Komanditer (CV/Commanditaire Vennootschap)
                                        </option>
                                        <option value="Persekutuan Firma (FA / Venootschap Onder Firma)" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Persekutuan Firma (FA / Venootschap Onder Firma)'): echo 'selected'; endif; ?>>
                                            Persekutuan Firma (FA / Venootschap Onder Firma)
                                        </option>
                                        <option value="Persekutuan Perdata" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Persekutuan Perdata'): echo 'selected'; endif; ?>>
                                            Persekutuan Perdata
                                        </option>
                                        <option value="Perusahaan Umum (Perum)" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Perusahaan Umum (Perum)'): echo 'selected'; endif; ?>>
                                            Perusahaan Umum (Perum)
                                        </option>
                                        <option value="Perusahaan Umum Daerah (Perumda)" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Perusahaan Umum Daerah (Perumda)'): echo 'selected'; endif; ?>>
                                            Perusahaan Umum Daerah (Perumda)
                                        </option>
                                        <option value="Badan Hukum Lainnya" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Badan Hukum Lainnya'): echo 'selected'; endif; ?>>
                                            Badan Hukum Lainnya
                                        </option>
                                        <option value="Koperasi" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Koperasi'): echo 'selected'; endif; ?>>
                                            Koperasi
                                        </option>
                                        <option value="Persekutuan dan Perkumpulan" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Persekutuan dan Perkumpulan'): echo 'selected'; endif; ?>>
                                            Persekutuan dan Perkumpulan
                                        </option>
                                        <option value="Yayasan" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Yayasan'): echo 'selected'; endif; ?>>
                                            Yayasan
                                        </option>
                                        <option value="Badan Layanan Umum" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'Badan Layanan Umum'): echo 'selected'; endif; ?>>
                                            Badan Layanan Umum
                                        </option>
                                        <option value="BUM Desa" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'BUM Desa'): echo 'selected'; endif; ?>>
                                            BUM Desa
                                        </option>
                                        <option value="BUM Desa Bersama" <?php if(old('jenis_badan_usaha', $permohonan->jenis_badan_usaha) == 'BUM Desa Bersama'): echo 'selected'; endif; ?>>
                                            BUM Desa Bersama
                                        </option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-pd-teknis">
                                    ...
                                    <input id="nama_usaha" name="nama_usaha" type="text"
                                        ...
                                        value="<?php echo e(old('nama_usaha', $permohonan->nama_usaha)); ?>" <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-pd-teknis">
                                    ...
                                    <textarea id="alamat_perusahaan" name="alamat_perusahaan"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                        <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?>><?php echo e(old('alamat_perusahaan', $permohonan->alamat_perusahaan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-pd-teknis">
                                    ...
                                    <select name="sektor" id="sektor"
                                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isDisabled(['dpmptsp','admin']) ? 'bg-gray-100' : ''); ?>"
                                        <?php echo e($isDisabled(['dpmptsp','admin']) ? 'disabled' : ''); ?>>
                                        ...
                                        <?php $__currentLoopData = $sektors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sektor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sektor); ?>" <?php if(old('sektor', $permohonan->sektor) == $sektor): echo 'selected'; endif; ?>>
                                                <?php echo e($sektor); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-pd-teknis">
                                    ...
                                    <input id="modal_usaha" name="modal_usaha" type="number"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                        value="<?php echo e(old('modal_usaha', $permohonan->modal_usaha)); ?>"
                                        <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-pd-teknis">
                                    ...
                                    <select name="jenis_proyek" id="jenis_proyek"
                                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isDisabled(['dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                        <?php echo e($isDisabled(['dpmptsp']) ? 'disabled' : ''); ?>>
                                        ...
                                        <?php $__currentLoopData = $jenisProyeks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proyek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($proyek); ?>" <?php if(old('jenis_proyek', $permohonan->jenis_proyek) == $proyek): echo 'selected'; endif; ?>>
                                                <?php echo e($proyek); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="nama_perizinan" name="nama_perizinan" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                        value="<?php echo e(old('nama_perizinan', $permohonan->nama_perizinan)); ?>" placeholder="Masukkan nama perizinan" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="skala_usaha" id="skala_usaha"
                                        ...
                                        <option value="Mikro" <?php if(old('skala_usaha', $permohonan->skala_usaha) == 'Mikro'): echo 'selected'; endif; ?>>Mikro</option>
                                        <option value="Kecil" <?php if(old('skala_usaha', $permohonan->skala_usaha) == 'Kecil'): echo 'selected'; endif; ?>>Kecil</option>
                                        <option value="Menengah" <?php if(old('skala_usaha', $permohonan->skala_usaha) == 'Menengah'): echo 'selected'; endif; ?>>Menengah</option>
                                        <option value="Besar" <?php if(old('skala_usaha', $permohonan->skala_usaha) == 'Besar'): echo 'selected'; endif; ?>>Besar</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="risiko" id="risiko"
                                        ...
                                        <option value="Rendah" <?php if(old('risiko', $permohonan->risiko) == 'Rendah'): echo 'selected'; endif; ?>>Rendah</option>
                                        <option value="Sedang" <?php if(old('risiko', $permohonan->risiko) == 'Sedang'): echo 'selected'; endif; ?>>Sedang</option>
                                        <option value="Tinggi" <?php if(old('risiko', $permohonan->risiko) == 'Tinggi'): echo 'selected'; endif; ?>>Tinggi</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="no_telephone" name="no_telephone" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                        value="<?php echo e(old('no_telephone', $permohonan->no_telephone)); ?>" placeholder="Masukkan nomor telephone" />
                                ...
                                <div class="hide-for-pd-teknis">
                                    ...
                                    <select name="verifikator" id="verifikator"
                                        ...
                                        <?php $__currentLoopData = $verifikators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verifikator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($verifikator); ?>" <?php if(old('verifikator', $permohonan->verifikator) == $verifikator): echo 'selected'; endif; ?>><?php echo e($verifikator); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isDisabled(['admin','dpmptsp','pd_teknis']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isDisabled(['admin','dpmptsp','pd_teknis']) ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="pengembalian" name="pengembalian" type="date"
                                        ...
                                        value="<?php echo e(old('pengembalian', $permohonan->pengembalian ? $permohonan->pengembalian->format('Y-m-d') : '')); ?>" <?php echo e($isReadOnly(['pd_teknis','dpmptsp','admin']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea id="keterangan_pengembalian" name="keterangan_pengembalian"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"><?php echo e(old('keterangan_pengembalian', $permohonan->keterangan_pengembalian)); ?></textarea>
                                ...
                                <div id="optional-fields" class="hide-for-pd-teknis hidden space-y-4 mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                    <div>
                                        ...
                                        <input id="menghubungi" name="menghubungi" type="date"
                                            ...
                                            value="<?php echo e(old('menghubungi', $permohonan->menghubungi ? $permohonan->menghubungi->format('Y-m-d') : '')); ?>" <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="keterangan_menghubungi" name="keterangan_menghubungi"
                                            class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'readonly' : ''); ?>><?php echo e(old('keterangan_menghubungi', $permohonan->keterangan_menghubungi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input id="status_menghubungi" name="status_menghubungi" type="text"
                                            class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                            value="<?php echo e(old('status_menghubungi', $permohonan->status_menghubungi)); ?>" <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input id="perbaikan" name="perbaikan" type="date"
                                            class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                            value="<?php echo e(old('perbaikan', $permohonan->perbaikan ? $permohonan->perbaikan->format('Y-m-d') : '')); ?>" <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="keterangan_perbaikan" name="keterangan_perbaikan"
                                            class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'readonly' : ''); ?>><?php echo e(old('keterangan_perbaikan', $permohonan->keterangan_perbaikan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-dpmptsp-only">
                                    ...
                                    <select name="verifikasi_dpmptsp" id="verifikasi_dpmptsp"
                                        ...
                                        <option value="">-- Pilih Status --</option>
                                        <?php $__currentLoopData = $verificationStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($opt); ?>" <?php if(old('verifikasi_dpmptsp', $permohonan->verifikasi_dpmptsp) == $opt): echo 'selected'; endif; ?>>
                                                <?php echo e($opt); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input id="terbit" name="terbit" type="date"
                                            class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                            value="<?php echo e(old('terbit', $permohonan->terbit ? $permohonan->terbit->format('Y-m-d') : '')); ?>" <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="keterangan_terbit" name="keterangan_terbit"
                                            class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'readonly' : ''); ?>><?php echo e(old('keterangan_terbit', $permohonan->keterangan_terbit)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="keterangan" name="keterangan"
                                            class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isReadOnly(['admin','dpmptsp']) ? 'readonly' : ''); ?>><?php echo e(old('keterangan', $permohonan->keterangan)); ?></textarea>
...
</script><?php /**PATH C:\xampp\htdocs\sistem-perizinan\resources\views/permohonan/edit.blade.php ENDPATH**/ ?>