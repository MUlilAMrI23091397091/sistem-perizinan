...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp">
                                    ...
                                    <select name="jenis_pelaku_usaha" id="jenis_pelaku_usaha"
                                        ...
                                        class="block mt-1 w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isDisabled(['pd_teknis']) ? 'bg-gray-100' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp" x-show="jenisPelakuUsaha === 'Badan Usaha'">
                                    ...
                                    <select name="jenis_badan_usaha" id="jenis_badan_usaha"
                                        class="block mt-1 w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['pd_teknis']) ? 'bg-gray-100' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-pd-teknis">
                                    ...
                                    <input id="nama_usaha" name="nama_usaha" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-pd-teknis">
                                    ...
                                    <select name="sektor" id="sektor"
                                        class="block mt-1 w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isDisabled(['dpmptsp','admin']) ? 'bg-gray-100' : ''); ?>"
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="hide-for-pd-teknis">
                                    ...
                                    <select name="verifikator" id="verifikator"
                                        class="block mt-1 w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isDisabled(['dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isDisabled(['dpmptsp']) ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" class="block mt-1 w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isDisabled(['admin','dpmptsp','pd_teknis']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isDisabled(['admin','dpmptsp','pd_teknis']) ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-pd-teknis-only">
                                    ...
                                    <select name="verifikasi_pd_teknis" id="verifikasi_pd_teknis"
                                        class="block mt-1 w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isDisabled(['admin','dpmptsp','pd_teknis']) ? 'bg-gray-100' : ''); ?>"
                                        <?php echo e($isDisabled(['admin','dpmptsp','pd_teknis']) ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="pengembalian" name="pengembalian" type="date"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['pd_teknis','dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                        value="<?php echo e(old('pengembalian', $permohonan->pengembalian ? $permohonan->pengembalian->format('Y-m-d') : '')); ?>" <?php echo e($isReadOnly(['pd_teknis','dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea id="keterangan_pengembalian" name="keterangan_pengembalian"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"><?php echo e(old('keterangan_pengembalian', $permohonan->keterangan_pengembalian)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="hide-for-pd-teknis">
                                        ...
                                        <input id="terbit" name="terbit" type="date"
                                            class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                            value="<?php echo e(old('terbit', $permohonan->terbit ? $permohonan->terbit->format('Y-m-d') : '')); ?>" <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="hide-for-pd-teknis">
                                        ...
                                        <textarea id="keterangan_terbit" name="keterangan_terbit"
                                            class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?>><?php echo e(old('keterangan_terbit', $permohonan->keterangan_terbit)); ?></textarea>
