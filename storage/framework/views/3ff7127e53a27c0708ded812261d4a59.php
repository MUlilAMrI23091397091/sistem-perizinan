...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp">
                                    ...
                                    <input id="kbli" name="kbli" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['pd_teknis']) ? 'bg-gray-100' : ''); ?>"
                                        value="<?php echo e(old('kbli')); ?>" placeholder="Masukkan nomor KBLI" <?php echo e($isReadOnly(['pd_teknis']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon hide-for-dpmptsp">
                                    ...
                                    <input id="inputan_teks" name="inputan_teks" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['pd_teknis']) ? 'bg-gray-100' : ''); ?>"
                                        value="<?php echo e(old('inputan_teks')); ?>" placeholder="Masukkan kegiatan" <?php echo e($isReadOnly(['pd_teknis']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="pengembalian" name="pengembalian" type="date"
                                        ...
                                        value="<?php echo e(old('pengembalian')); ?>" <?php echo e($isReadOnly(['pd_teknis','dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="hide-for-pd-teknis">
                                    ...
                                    <input id="menghubungi" name="menghubungi" type="date"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"
                                        value="<?php echo e(old('menghubungi')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="hide-for-pd-teknis">
                                    ...
                                    <textarea id="keterangan_menghubungi" name="keterangan_menghubungi"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"><?php echo e(old('keterangan_menghubungi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="hide-for-pd-teknis">
                                    ...
                                    <input id="perbaikan" name="perbaikan" type="date"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"
                                        value="<?php echo e(old('perbaikan')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="hide-for-pd-teknis">
                                    ...
                                    <textarea id="keterangan_perbaikan" name="keterangan_perbaikan"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"><?php echo e(old('keterangan_perbaikan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="hide-for-pd-teknis">
                                        ...
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                        value="<?php echo e(old('terbit')); ?>" <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="hide-for-pd-teknis">
                                        ...
                                        <textarea id="keterangan_terbit" name="keterangan_terbit"
                                            class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?>><?php echo e(old('keterangan_terbit')); ?></textarea>
