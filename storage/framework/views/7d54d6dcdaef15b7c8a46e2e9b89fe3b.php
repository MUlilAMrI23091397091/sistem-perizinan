...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Tambah Staff Baru <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                                ...
                                <div id="sektor-field" style="display: none;">
                                    <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'sektor','value' => 'Sektor']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'sektor','value' => 'Sektor']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
...
<?php endif; ?>
                                    <select name="sektor" id="sektor" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                        ...
                                        <option value="Dinkopdag" <?php if(old('sektor') == 'Dinkopdag'): echo 'selected'; endif; ?>>Dinkopdag - Dinas Koperasi dan Perdagangan</option>
                                        <option value="Disbudpar" <?php if(old('sektor') == 'Disbudpar'): echo 'selected'; endif; ?>>Disbudpar - Dinas Kebudayaan dan Pariwisata</option>
                                        <option value="Dinkes" <?php if(old('sektor') == 'Dinkes'): echo 'selected'; endif; ?>>Dinkes - Dinas Kesehatan</option>
                                        <option value="Dishub" <?php if(old('sektor') == 'Dishub'): echo 'selected'; endif; ?>>Dishub - Dinas Perhubungan</option>
                                        <option value="Dprkpp" <?php if(old('sektor') == 'Dprkpp'): echo 'selected'; endif; ?>>Dprkpp - Dinas Pemberdayaan Perempuan dan Perlindungan Anak</option>
                                        <option value="Dkpp" <?php if(old('sektor') == 'Dkpp'): echo 'selected'; endif; ?>>Dkpp - Dinas Ketahanan Pangan dan Perikanan</option>
                                        <option value="Dlh" <?php if(old('sektor') == 'Dlh'): echo 'selected'; endif; ?>>Dlh - Dinas Lingkungan Hidup</option>
                                        <option value="Disperinaker" <?php if(old('sektor') == 'Disperinaker'): echo 'selected'; endif; ?>>Disperinaker - Dinas Perindustrian dan Tenaga Kerja</option>
                                    </select>
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('sektor'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('sektor')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                            <a href="<?php echo e(route('users.index')); ?>" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-200">
                                Batal
                            </a>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\sistem-perizinan\resources\views/users/create.blade.php ENDPATH**/ ?>