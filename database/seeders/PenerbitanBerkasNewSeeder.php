...
class PenerbitanBerkasNewSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info('Creating penerbitan berkas data...');

        // Data penerbitan berkas dengan format yang benar
        $data = [
            [
                ...
                'nama_perusahaan' => 'PT. BERKAS SIAP TERBIT',
            ...
            [
                ...
                'nama_perusahaan' => 'CV. DOKUMEN LENGKAP',
            ...
            [
                ...
                'inputan_teks' => 'Pergudangan dan Penyimpanan',
                'jenis_pelaku_usaha' => 'PT',
                'nama_perusahaan' => 'PT. FINAL APPROVAL',
        ...
        $this->command->info('- Pemroses: Complete document processing information');
    }
}
