    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= 30; $i++) {
            ...
            $dataPermohonan[] = [
                ...
                'nama_perizinan' => 'Izin ' . ['Usaha', 'Operasional', 'Komersial', 'Produksi'][array_rand(['Usaha', 'Operasional', 'Komersial', 'Produksi'])],
                'skala_usaha' => $verifikasiStatus[array_rand($verifikasiStatus)],
                'risiko' => ['Rendah', 'Sedang', 'Tinggi'][array_rand(['Rendah', 'Sedang', 'Tinggi'])],
            'jangka_waktu' => rand(5, 30),
            'no_telephone' => '08' . rand(100000000, 999999999),
            'deadline' => now()->addDays(rand(1, 60))->format('Y-m-d'),
