                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-6">
                    ...
                    <div class="p-6">
                        <div class="space-y-6">
                            ...
                            <div class="group">
                                <div class="flex items-center space-x-3 mb-3">
                                    <div class="w-8 h-8 {{ $permohonan->verifikasi_dpmptsp ? 'bg-purple-500' : 'bg-gray-300' }} rounded-full flex items-center justify-center">
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="ml-11 space-y-2">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-sm font-medium {{ $permohonan->verifikasi_dpmptsp ? 'text-purple-600' : 'text-gray-400' }}">
                                            {{ $permohonan->verifikasi_dpmptsp ?? 'Belum ada' }}
                                        </span>
                                    </div>
                                </div>
                            </div>
