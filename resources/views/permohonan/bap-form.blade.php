        ...
        <form method="POST" action="{{ route('permohonan.bap.generate', $permohonan) }}" 
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="nama_pelaku_usaha" class="block text-sm font-medium text-gray-700 mb-1">Nama Pelaku Usaha</label>
                        <input type="text" id="nama_pelaku_usaha" name="nama_pelaku_usaha" value="{{ $permohonan->pemilik ?? $permohonan->user->name ?? 'N/A' }}" readonly
                               class="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-600">
                    </div>
                    <div>
                        <label for="alamat_pelaku_usaha" class="block text-sm font-medium text-gray-700 mb-1">Alamat Pelaku Usaha</label>
                        <input type="text" id="alamat_pelaku_usaha" name="alamat_pelaku_usaha" value="{{ $permohonan->alamat_perusahaan ?? 'N/A' }}" readonly
                               class="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-600">
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="flex justify-center mb-8">
                    <div class="w-full md:w-1/2">
                        <label class="block text-sm font-medium text-gray-700 mb-2 text-center">Mengetahui</label>
                        ...
                        <input type="hidden" id="ttd_mengetahui" name="ttd_mengetahui" value="">
                        <div class="mt-3 space-y-2">
                            <div>
