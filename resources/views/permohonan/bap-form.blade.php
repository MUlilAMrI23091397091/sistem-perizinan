...
<x-sidebar-layout>
    ...
    <div class="space-y-6 pb-12 bap-form-container">
        @if ($errors->any() || session('error'))
            <div class="mb-6 bg-red-50 border-l-4 border-red-500 rounded-lg p-4" x-data="{ show: true }" x-show="show" x-transition>
                <div class="flex items-start">
                    ...
                    <div class="ml-3 flex-1">
                        <h3 class="text-sm font-semibold text-red-800 mb-2">Terjadi kesalahan saat generate PDF</h3>
                        @if ($errors->any())
                        ...
                        @endif
                        <button @click="show = false" class="mt-3 text-xs text-red-600 hover:text-red-800 underline">
                            Tutup pesan ini
                        </button>
                    </div>
                </div>
