                    ...
                    <form method="POST" action="{{ route('ttd-settings.update') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    <x-input-label for="mengetahui_photo" value="Tanda Tangan Digital Mengetahui" />
                                        ...
                                        @if($ttdSettings->mengetahui_photo)
                                            <div class="mt-3 p-3 bg-gray-50 rounded-lg">
                                                ...
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    @endphp
                                                    @if($url)
                                                        <img src="{{ $url }}" alt="TTD Mengetahui" class="w-64 h-40 object-contain border border-gray-300 rounded bg-white">
                                                    @endif
                                                    <div>
                        ...
                        <div class="pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    <x-input-label for="menyetujui_photo" value="Tanda Tangan Digital Menyetujui" />
                                        ...
                                        @if($ttdSettings->menyetujui_photo)
                                            <div class="mt-3 p-3 bg-gray-50 rounded-lg">
                                                ...
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    @endphp
                                                    @if($url)
                                                        <img src="{{ $url }}" alt="TTD Menyetujui" class="w-64 h-40 object-contain border border-gray-300 rounded bg-white">
                                                    @endif
                                                    <div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="h-32 border-b border-gray-300 mb-2 flex items-center justify-center">
                            @if($ttdSettings->mengetahui_photo)
                                ...
                                @endphp
                                @if($url)
                                    <img src="{{ $url }}" alt="TTD Mengetahui" class="max-h-32 max-w-64 object-contain">
                                @endif
                            @endif
                        </div>
