        ...
        <div class="flex items-start">
            ...
            <div class="ml-3 flex-1">
                <h3 class="text-sm font-medium text-yellow-800">
                    Reminder: Ada {{ $dikembalikanCount }} berkas yang dikembalikan
                </h3>
                ...
                <div class="mt-3">
                    <a href="{{ route('permohonan.index', ['status' => 'Dikembalikan']) }}" 
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-table-header">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-table-header">Sektor</th>
                                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-table-header">Status</th>
                                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-table-header">Tanggal Dibuat</th>
                                    ...
                                    <tr class="hover:bg-primary-50 transition-colors duration-200">
                                        ...
                                        <td class="px-4 py-4 text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                <a href="{{ route('permohonan.bap', $permohonan) }}" class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                                                    BAP
                                                </a>
                                            </div>
                                        </td>
