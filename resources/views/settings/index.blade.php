<x-sidebar-layout>
    ...
    <!-- TTD Settings Card (Admin & Penerbitan Berkas) -->
    ...
    <!-- App Settings / Koordinator BAP Card (Admin Only) -->
    ...
    <!-- Info untuk user yang tidak punya akses -->
    @if(!$canAccessTtdSettings && !$canAccessAppSettings)
        ...
        <div class="flex items-start">
            ...
            <div>
                <p class="text-sm font-medium text-yellow-800 mb-1">
                    Tidak ada pengaturan yang dapat diakses
                </p>
                <p class="text-sm text-yellow-700">
                    Anda tidak memiliki izin untuk mengakses pengaturan sistem. Hubungi administrator untuk informasi lebih lanjut.
                </p>
            </div>
        </div>
    </div>
